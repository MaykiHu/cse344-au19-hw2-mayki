...
**Due date:** Wednesday October 9, 2019, 11pm. You have 1 week for this assignment. Push your code to your hw2 repo, `https://gitlab.cs.washington.edu/cse344-au19/hw2/cse344-hw2-[your CSE username]`. 

**Questions:** Make sure your post them on [Ed Discuss](https://us.edstem.org/courses/130/discussion/). 
...
## Obtaining Changes
If we release major changes to the homework, we will announce it on Ed Discuss. Then you will need to set the upstream master on your repository to `cse344-au19/source/hw1` and pull the changes - `git pull upstream master` in your repository directory. It will pull the updated HW2 contents (including this file) into your repository. See HW1 for details on how to set the upstream remote.
...
```sh
$ git clone git@gitlab.cs.washington.edu:cse344-au19/hw2/cse344-hw2-[your CSE username].git confirmation_directory
